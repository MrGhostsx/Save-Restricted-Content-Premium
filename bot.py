...
async def my_plan(client, message):
    ...
    if user_id in approved_users:
        ...
        if time_left.total_seconds() > 0:
            ...
            await message.reply("Your plan has expired. Please contact the admin to Buy Premium @Smart_EdithBot")
    else:
        await message.reply("You do not have an active plan. Please contact the admin to Buy Premium @Smart_EdithBot")
...
async def check_user_approval(client, message):
    ...
    if is_user_approved(user_id, approved_users):
        ...
        await message.reply("You are not approved to use this bot. Please contact the admin to Buy Premium @Smart_EdithBot")
